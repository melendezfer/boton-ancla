...
Versión 0.14 · Primera app base: RUTEANDO · Destino: componente integrable en cualquier app
...
|---|---|---|
| Mapa `MapTrifold` | Buscar (1), Mi ubicación (2), Ofertas cerca `Tag` (3), Favoritos `ListHeart` (4), Zoom `MagnifyingGlassPlus` (5, deslizador, HM-12a) | normal |
