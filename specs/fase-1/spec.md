...
Versión 0.13 · Primera app base: RUTEANDO · Destino: componente integrable en cualquier app
...
useAnchorPan(mover: (dx: number, dy: number) => boolean | void): void;  // registra un mapa: mover la vista dx, dy px hacia donde apunta el pulgar; false = llegó al borde (HM-11)
