...
| HM-06 / HM-08 | ⏳ HM-06 aceptado (A, "modo escritura") e integrado en HM-08: cada capa declara sus acciones; con capa abierta, "Cerrar" a 90° + acciones de la capa, y las de fondo se ocultan. Pendiente de 3 preguntas (`decisiones-pendientes.md`). | spec §12 |
